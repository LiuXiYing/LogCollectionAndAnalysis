...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 虚拟机 IP 地址 |192.168.118.128  |
| 网络模式 | NAT / 其他： |
| ping `223.5.5.5` 是否成功 |成功 |
| ping `mirrors.tuna.tsinghua.edu.cn` 是否成功 |成功 |
| 使用的软件源镜像站 |[mirrors.tuna.tsinghua.edu.cn](https://mirrors.tuna.tsinghua.edu.cn) |
...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 宿主机内存 / CPU 核心 / 存放盘剩余空间 |16.0GB / 8 核 / 107GB |
| 选择的配置档位 |课程推荐档|
| 虚拟 CPU 核心数 |2 |
| 虚拟内存 |5.7Gi |
| 虚磁盘容量 |40G |
...
| 项目 | 你的填写内容 |
| :--- | :--- |
| VMware Tools 版本 |13.0.10.10.0 (build‑25056151) |
...
| 虚拟机联网 | 具有 IP 和默认路由，IP 联通与 DNS 解析正常 |成功 |
| 国内软件源 | 已换成国内镜像站，`sudo apt update` 成功 |成功 |

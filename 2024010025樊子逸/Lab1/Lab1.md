...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 已安装的 VMware 完整版本号 |VMware Workstation Pro 26H1 for Windows，版本 26.0.0 build‑25388281|
| 是否为教师指定版本 |是|
...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 宿主机内存 / CPU 核心 / 存放盘剩余空间 |内存 16.0GB；CPU i5‑12500H 2.50GHz；磁盘剩余495GB|
| 选择的配置档位 | 课程推荐档 |
| 虚拟 CPU 核心数 |2|
| 虚拟内存 |6GB|
| 虚磁盘容量 |40G|
...
> 填写：
配置国内软件源时手动输入配置文件容易出现拼写、空格语法错误，导致 apt 无法读取软件仓库。先使用系统原始官方源安装 open‑vm‑tools 组件，实现主机虚拟机剪贴板互通，之后复制粘贴镜像源配置完成换源。全部验收项目均合格，当前环境可以继续完成后续实验。
---

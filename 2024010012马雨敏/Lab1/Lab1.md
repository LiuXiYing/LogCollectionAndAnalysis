...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 虚拟机 IP 地址 | 192.168.125.128|
| 网络模式 | NAT | ping `223.5.5.5` 是否成功 | 成功|
...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 宿主机内存 / CPU 核心 / 存放盘剩余空间 | CPU 16核；内存：32.0GB；C盘剩余146GB	|
| 选择的配置档位 | 课程推荐档 |
| 虚拟 CPU 核心数 | 2|
| 虚拟内存 | 5.7G|
| 虚磁盘容量 |40G |
...
> 填写：遇到的问题：访问清华镜像源出现25%丢包，网络存在轻微不稳定。
解决方法：执行sudo apt update完成软件源更新。
当前环境：系统、虚拟机硬件资源、open‑vm‑tools、ssh、rsyslog组件均工作正常，可继续完成后续实验。

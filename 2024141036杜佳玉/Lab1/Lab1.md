...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 已安装的 VMware 完整版本号 |VMware Workstation Pro 26H1 for Windows 26.0.0.25388281 |
| 是否为教师指定版本 |是 |
...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 虚拟机 IP 地址 |192.168.150.128 |
| 网络模式 | NAT|
| ping `223.5.5.5` 是否成功 |成功，0% 丢包|
| ping `mirrors.tuna.tsinghua.edu.cn` 是否成功 |成功，0% 丢包|
| 使用的软件源镜像站 |清华大学镜像站（[mirrors.tuna.tsinghua.edu.cn](https://mirrors.tuna.tsinghua.edu.cn)）|
| `sudo apt update` 是否成功 |成功，获取 11.0MB 索引，402 个软件包可升级|
| 联网是否合格 |合格|
...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 宿主机内存 / CPU 核心 / 存放盘剩余空间 |宿主机内存 24368MB；CPU 核心看 VMware 关于页面；存放磁盘有充足剩余空间|
| 选择的配置档位 |课程推荐档|
| 虚拟 CPU 核心数 |2|
| 虚拟内存 |5.7Gi|
| 虚磁盘容量 |40G|

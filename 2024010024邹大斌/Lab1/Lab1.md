...
| 项目 | 你的填写内容 |
| :--- | :--- |
| Ubuntu 当前完整版本 |PRETTY_NAME="Ubuntu 24.04.4 LTS"|
...
按仓库 `README.md` 第 4 节的规则：不晚于 9 月 10 日 23:59:59 创建 PR 不算超时，9 月 4 日 00:00 起创建 PR 算作超时。时间按北京时间计算，并以 GitHub 记录的 PR 首次创建时间为准。
